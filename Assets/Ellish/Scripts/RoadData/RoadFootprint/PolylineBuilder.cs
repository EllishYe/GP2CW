...
public class PolylineBuilder
{
    ...
    public Paths64 Build()
    {
        ...
        AddMajorPolylines(result);
        AddMinorPolylines(result);
        return result;
    }

    public Paths64 BuildMajor()
    {
        visited.Clear();
        Paths64 result = new Paths64();
        AddMajorPolylines(result);
    ...
    private void AddMajorPolylines(Paths64 result)
    {
    ...
    private void AddMinorPolylines(Paths64 result)
    {
